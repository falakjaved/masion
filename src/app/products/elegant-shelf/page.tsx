...
export default function ElegantShelfPage() {
  const { addItem } = useCart();

  const product = {
    id: "elegant-shelf-001",
    name: "Elegant Shelf",
    price: 95,
    category: "Decor",
  };
    ...
    <main className="container mx-auto px-4 py-14">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-3xl font-bold">Elegant Shelf</h1>
          <p className="text-xl font-semibold text-gray-700">$95</p>
          <p className="text-sm text-gray-500">Category: Decor</p>
          <p className="mt-4 text-gray-600">
            Beautiful elegant shelf for your living room or bedroom. Display decor or books with style.
          </p>
