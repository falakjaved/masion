    ...
    <main className="container mx-auto px-4 py-14">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-3xl font-bold">Side Table</h1>
          <p className="text-xl font-semibold text-gray-700">$90</p>
          <p className="text-sm text-gray-500">Category: Living</p>
          <p className="mt-4 text-gray-600">
            Compact side table ideal for living rooms or bedrooms. Perfect for decor, books, or beverages.
          </p>
          <button 
