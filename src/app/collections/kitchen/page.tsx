...
export const metadata = {
  title: "Kitchen Collection | Premium E-Commerce",
  description: "Elevate your culinary space with functional elegance and modern design.",
};
      ...
      <main className="min-h-screen px-6 py-16 md:py-24 max-w-7xl mx-auto">
        ...
        <div className="relative mb-16">
          ...
          <div className="absolute bottom-6 left-6 text-white">
            <h1 className="font-serif text-4xl md:text-5xl">Kitchen Collection</h1>
        ...
        <section className="mb-16">
          ...
          <p className="text-muted-foreground mb-6">
            This collection includes 56 items like kitchen islands, stools, and modern appliances for a functional kitchen.
          </p>
          <Link
            href="/shop"
