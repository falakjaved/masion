...
export const metadata = {
  title: "Office Collection | Premium E-Commerce",
  description: "Productivity meets sophistication in our curated workspace essentials.",
};
      ...
      <main className="min-h-screen px-6 py-16 md:py-24 max-w-7xl mx-auto">
        ...
        <div className="relative mb-16">
          ...
          <div className="absolute bottom-6 left-6 text-white">
            <h1 className="font-serif text-4xl md:text-5xl">Office Collection</h1>
        ...
        <section className="mb-16">
          ...
          <p className="text-muted-foreground mb-6">
            This collection includes 29 items like desks, chairs, and storage solutions for a productive office.
          </p>
          <Link
            href="/shop"
