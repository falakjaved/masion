...
export const metadata = {
  title: "Outdoor Collection | Premium E-Commerce",
      ...
      <main className="min-h-screen px-6 py-16 md:py-24 max-w-7xl mx-auto">
        ...
        <div className="relative mb-16">
          ...
          <div className="absolute bottom-6 left-6 text-white">
            <h1 className="font-serif text-4xl md:text-5xl">Outdoor Collection</h1>
            <p className="mt-2 text-lg max-w-md">
              Extend your living space with premium outdoor furnishings.
            </p>
          </div>
        </div>
        ...
        <section className="mb-16">
          ...
          <p className="text-muted-foreground mb-6">
            This collection includes 34 items like patio sets, outdoor seating, umbrellas, and decor.
          </p>
          <Link
            href="/shop"
