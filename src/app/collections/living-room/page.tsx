...
export const metadata = {
  title: "Living Room Collection | Premium E-Commerce",
  description: "Transform your living room with carefully curated premium furniture and decor.",
};
      ...
      <main className="min-h-screen px-6 py-16 md:py-24 max-w-7xl mx-auto">
        ...
        <div className="relative mb-16">
          ...
          <div className="absolute bottom-6 left-6 text-white">
            <h1 className="font-serif text-4xl md:text-5xl">Living Room Collection</h1>
        ...
        <section className="mb-16">
          ...
          <p className="text-muted-foreground mb-6">
            This collection includes 42 items including sofas, coffee tables, accent chairs, and decor pieces.
          </p>
          <Link
            href="/shop"
